...
//         /**
//          * preserve some settings if they exist
//          */
...
//         // debug
//         // @ts-expect-error: poorly typed
//         const markLine = props.options.series?.[0]?.markLine
//         console.log('Applying options', JSON.stringify({ markLine }, null, 2))

//         // strip the markLine from the initial render
//         const cleanOptions = {
//             ...props.options,
//             // @ts-expect-error: poorly typed
//             series: props.options.series?.map((s, idx) => (idx === 0 ? { ...s, markLine: undefined } : s)),
//         }
...
//         // delay re-applying markLine
//         requestAnimationFrame(() => {
//             if (markLine) {
//                 myChart.current?.setOption({
//                     series: [{ name: 'Bids', markLine }],
//                 })
//             }
//         })

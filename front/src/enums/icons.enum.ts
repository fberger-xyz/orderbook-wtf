...
export enum IconIds {
    ...
    DISCONNECT = 'mi:log-out', // 'ant-design:disconnect-outlined',
    DEBANK = 'DEBANK',
    SAFE = 'SAFE',
    SPARK = 'SPARK',
    ...
    BSC = 'token-branded:binance-smart-chain',
    GNOSIS = 'token-branded:gnosis',
    POLYGON = 'token-branded:polygon-pos',
    ZKSYNC_ERA = 'token-branded:zksync',
    ...
    INFORMATION = 'iconamoon:information-circle-fill',
}
